...
public enum NamedOpcode {
     ...
     * Description: getMetadata the length of an array
     */
    ARRAYLENGTH(0xbe),
    ...
    /**
     * Stack [before] -> [after]: value1, value2 ? result
     * Description: getMetadata the remainder from a division between two doubles
     */
    DREM(0x73),
    ...
    /**
     * Stack [before] -> [after]: value1, value2 ? result
     * Description: getMetadata the remainder from a division between two floats
     */
    FREM(0x72),
     ...
     * Description: getMetadata a field value of an object objectref, where the field is identified by field reference in the constant pool index (index1 << 8 + index2)
     */
    GETFIELD(0xb4),

    /**
     * Stack [before] -> [after]: ? value
     * Description: getMetadata a static field value of a class, where the field is identified by field reference in the constant pool index (index1 << 8 + index2)
     */
    GETSTATIC(0xb2),
    ...
    public static NamedOpcode getByValue(byte index) {
        for (NamedOpcode b : values())
            if (b.val == index)
                return b;
        return null;
    }
