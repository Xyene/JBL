...
import net.sf.jbl.introspection.members.attributes.*;
...
import static net.sf.jbl.introspection.Opcode.TAG_DOUBLE;
import static net.sf.jbl.introspection.Opcode.TAG_PHANTOM;
