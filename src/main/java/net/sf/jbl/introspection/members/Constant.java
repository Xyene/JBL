package net.sf.jbl.introspection.members;
...
public class Constant {
     ...
     */
    public void setOwner(Pool<Constant> owner) {
        this.owner = owner;
    }
    ...
    public String toString() {
        return "[I=" + index + ", T=" + Integer.toHexString(type) + ", V='" + stringValue() + "']";
    }
    ...
    public String stringValue() {
        try {
            switch (type) {
                ...
                case TAG_STRING:
                case TAG_CLASS:
                    return owner.get(Bytes.toShort(value, 0)).stringValue();
                case TAG_METHOD:
                case TAG_FIELD:
            ...
            throw new UnsupportedOperationException("Could not get String value of " + Integer.toHexString(type) + " @ " + index);
        }
    }
}
