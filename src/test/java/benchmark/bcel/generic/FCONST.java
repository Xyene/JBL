...
public class FCONST extends Instruction implements ConstantPushInstruction, TypedInstruction {
    ...
    public FCONST(float f) {
        super(benchmark.bcel.Constants.FCONST_0, (short) 1);
        if (f == 0.0) {
            opcode = benchmark.bcel.Constants.FCONST_0;
        } else if (f == 1.0) {
            opcode = benchmark.bcel.Constants.FCONST_1;
        } else if (f == 2.0) {
            opcode = benchmark.bcel.Constants.FCONST_2;
        } else {
