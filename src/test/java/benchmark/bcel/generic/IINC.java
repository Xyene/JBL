...
public class IINC extends LocalVariableInstruction {
    ...
    public IINC(int n, int c) {
        ...
        this.opcode = benchmark.bcel.Constants.IINC;
        this.length = (short) 3;
    ...
    public void dump( DataOutputStream out ) throws IOException {
        if (wide) {
            out.writeByte(benchmark.bcel.Constants.WIDE);
        }
    ...
    private final void setWide() {
        wide = (n > benchmark.bcel.Constants.MAX_BYTE) || (Math.abs(c) > Byte.MAX_VALUE);
        if (wide) {
