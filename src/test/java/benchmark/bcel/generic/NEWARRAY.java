...
public class NEWARRAY extends Instruction implements AllocationInstruction, ExceptionThrower,
    ...
    public NEWARRAY(byte type) {
        super(benchmark.bcel.Constants.NEWARRAY, (short) 2);
        this.type = type;
    }
    ...
    public String toString( boolean verbose ) {
        return super.toString(verbose) + " " + benchmark.bcel.Constants.TYPE_NAMES[type];
    }
    ...
    public Class[] getExceptions() {
        return new Class[] {
            benchmark.bcel.ExceptionConstants.NEGATIVE_ARRAY_SIZE_EXCEPTION
        };
    }
