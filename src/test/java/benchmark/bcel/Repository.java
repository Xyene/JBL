 ...
 *
 */
package benchmark.bcel;

import java.io.IOException;
import benchmark.bcel.classfile.JavaClass;
import benchmark.bcel.util.ClassPath;
 ...
 *
 * @see benchmark.bcel.util.Repository
 * @see benchmark.bcel.util.SyntheticRepository
 *
...
public abstract class Repository {
    ...
    private static benchmark.bcel.util.Repository _repository = SyntheticRepository.getInstance();


    /** @return currently used repository instance
     */
    public static benchmark.bcel.util.Repository getRepository() {
        return _repository;
    }
     ...
     */
    public static void setRepository( benchmark.bcel.util.Repository rep ) {
        _repository = rep;
    }
