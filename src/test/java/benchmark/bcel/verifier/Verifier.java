...
import benchmark.bcel.verifier.statics.Pass1Verifier;
import benchmark.bcel.verifier.statics.Pass2Verifier;
import benchmark.bcel.verifier.statics.Pass3aVerifier;
import benchmark.bcel.verifier.structurals.Pass3bVerifier;
 ...
 * @author Enver Haase
 * @see benchmark.bcel.verifier.VerifierFactory
 * @see benchmark.bcel.verifier.PassVerifier
 */
        ...
        while (p3as.hasNext()) {
            ...
            for (int i = 0; i < p3am.length; i++) {
                messages.add("Pass 3a, method " + meth + " ('"
                        + benchmark.bcel.Repository.lookupClass(classname).getMethods()[meth]
                        + "'): " + p3am[i]);
            }
        }
        ...
        for (int k = 0; k < args.length; k++) {
            try {
                ...
                if (vr == VerificationResult.VR_OK) {
                    JavaClass jc = benchmark.bcel.Repository.lookupClass(args[k]);
                ...
                // avoid swapping.
                v.flush();
                benchmark.bcel.Repository.clearCache();
                System.gc();
