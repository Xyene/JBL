...
import benchmark.bcel.verifier.exc.StructuralCodeConstraintException;
 ...
 * @author Enver Haase
 * @see benchmark.bcel.verifier.exc.StructuralCodeConstraintException
 * @see benchmark.bcel.verifier.exc.LinkingConstraintException
 */
public class InstConstraintVisitor extends EmptyVisitor implements benchmark.bcel.generic.Visitor{
   ...
   * @throws benchmark.bcel.verifier.exc.StructuralCodeConstraintException always.
   */
	 ...
	 * @throws benchmark.bcel.verifier.exc.StructuralCodeConstraintException if the above constraint is not satisfied.
	 */
	 ...
	 * @throws benchmark.bcel.verifier.exc.StructuralCodeConstraintException if the above constraint is violated.
 	 */
