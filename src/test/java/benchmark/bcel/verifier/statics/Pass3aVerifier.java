 ...
 *
 */ 
package benchmark.bcel.verifier.statics;


import benchmark.bcel.Constants;
import benchmark.bcel.Repository;
import benchmark.bcel.classfile.Attribute;
import benchmark.bcel.classfile.Code;
import benchmark.bcel.classfile.CodeException;
import benchmark.bcel.classfile.Constant;
import benchmark.bcel.classfile.ConstantClass;
import benchmark.bcel.classfile.ConstantDouble;
import benchmark.bcel.classfile.ConstantFieldref;
import benchmark.bcel.classfile.ConstantFloat;
import benchmark.bcel.classfile.ConstantInteger;
import benchmark.bcel.classfile.ConstantInterfaceMethodref;
import benchmark.bcel.classfile.ConstantLong;
import benchmark.bcel.classfile.ConstantMethodref;
import benchmark.bcel.classfile.ConstantNameAndType;
import benchmark.bcel.classfile.ConstantString;
import benchmark.bcel.classfile.ConstantUtf8;
import benchmark.bcel.classfile.Field;
import benchmark.bcel.classfile.JavaClass;
import benchmark.bcel.classfile.LineNumber;
import benchmark.bcel.classfile.LineNumberTable;
import benchmark.bcel.classfile.LocalVariable;
import benchmark.bcel.classfile.LocalVariableTable;
import benchmark.bcel.classfile.Method;
import benchmark.bcel.generic.ALOAD;
import benchmark.bcel.generic.ANEWARRAY;
import benchmark.bcel.generic.ASTORE;
import benchmark.bcel.generic.ATHROW;
import benchmark.bcel.generic.ArrayType;
import benchmark.bcel.generic.BREAKPOINT;
import benchmark.bcel.generic.CHECKCAST;
import benchmark.bcel.generic.ConstantPoolGen;
import benchmark.bcel.generic.DLOAD;
import benchmark.bcel.generic.DSTORE;
import benchmark.bcel.generic.FLOAD;
import benchmark.bcel.generic.FSTORE;
import benchmark.bcel.generic.FieldInstruction;
import benchmark.bcel.generic.GETSTATIC;
import benchmark.bcel.generic.GotoInstruction;
import benchmark.bcel.generic.IINC;
import benchmark.bcel.generic.ILOAD;
import benchmark.bcel.generic.IMPDEP1;
import benchmark.bcel.generic.IMPDEP2;
import benchmark.bcel.generic.INSTANCEOF;
import benchmark.bcel.generic.INVOKEINTERFACE;
import benchmark.bcel.generic.INVOKESPECIAL;
import benchmark.bcel.generic.INVOKESTATIC;
import benchmark.bcel.generic.INVOKEVIRTUAL;
import benchmark.bcel.generic.ISTORE;
import benchmark.bcel.generic.Instruction;
import benchmark.bcel.generic.InstructionHandle;
import benchmark.bcel.generic.InstructionList;
import benchmark.bcel.generic.InvokeInstruction;
import benchmark.bcel.generic.JsrInstruction;
import benchmark.bcel.generic.LDC;
import benchmark.bcel.generic.LDC2_W;
import benchmark.bcel.generic.LLOAD;
import benchmark.bcel.generic.LOOKUPSWITCH;
import benchmark.bcel.generic.LSTORE;
import benchmark.bcel.generic.LoadClass;
import benchmark.bcel.generic.MULTIANEWARRAY;
import benchmark.bcel.generic.NEW;
import benchmark.bcel.generic.NEWARRAY;
import benchmark.bcel.generic.ObjectType;
import benchmark.bcel.generic.PUTSTATIC;
import benchmark.bcel.generic.RET;
import benchmark.bcel.generic.ReturnInstruction;
import benchmark.bcel.generic.TABLESWITCH;
import benchmark.bcel.generic.Type;
import benchmark.bcel.verifier.PassVerifier;
import benchmark.bcel.verifier.VerificationResult;
import benchmark.bcel.verifier.Verifier;
import benchmark.bcel.verifier.VerifierFactory;
import benchmark.bcel.verifier.exc.AssertionViolatedException;
import benchmark.bcel.verifier.exc.ClassConstraintException;
import benchmark.bcel.verifier.exc.InvalidMethodException;
import benchmark.bcel.verifier.exc.StaticCodeConstraintException;
import benchmark.bcel.verifier.exc.StaticCodeInstructionConstraintException;
import benchmark.bcel.verifier.exc.StaticCodeInstructionOperandConstraintException;
...
public final class Pass3aVerifier extends PassVerifier{
	 ...
	 */
	private class InstOperandConstraintVisitor extends benchmark.bcel.generic.EmptyVisitor{
